...
#define KEY_UP			GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_2)
#define KEY_PUSH		GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_1)
#define KEY_DOWN		GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_0)
